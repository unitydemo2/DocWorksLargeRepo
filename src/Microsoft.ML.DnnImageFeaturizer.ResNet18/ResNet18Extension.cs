...
namespace Microsoft.ML.Transforms
{
            ...
            public static class ResNet18Extension
    {
        ///     <summary>
                ...
                ///     </summary>
                        public static EstimatorChain<ColumnCopyingTransformer> ResNet18(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string inputColumn, string outputColumn)
        {
        ...
        ///     <summary>
                ...
                ///     </summary>
                        public static EstimatorChain<ColumnCopyingTransformer> ResNet18(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string inputColumn, string outputColumn, string modelDir)
        {
            ...
            var midRename = new ColumnCopyingEstimator(env, new[] { ("PreprocessedInput", "Input247") });
            var endRename = new ColumnCopyingEstimator(env, new[] { ("Pooling395_Output_0", outputColumn) });
