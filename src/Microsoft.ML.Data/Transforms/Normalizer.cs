...
namespace Microsoft.ML.Transforms.Normalizers
{
    ...
    public sealed partial class NormalizingTransformer : OneToOneTransformerBase
    {
        ...
        /// <!-- Badly formed XML comment ignored for member "T:Microsoft.ML.Transforms.Normalizers.NormalizingTransformer.AffineNormalizerModelParameters`1" -->
                        public sealed class AffineNormalizerModelParameters<TData> : NormalizerModelParametersBase
        {
            /// <!-- Badly formed XML comment ignored for member "P:Microsoft.ML.Transforms.Normalizers.NormalizingTransformer.AffineNormalizerModelParameters`1.Scale" -->
        ...
        /// <!-- Badly formed XML comment ignored for member "T:Microsoft.ML.Transforms.Normalizers.NormalizingTransformer.CdfNormalizerModelParameters`1" -->
                        ...
                        public sealed class BinNormalizerModelParameters<TData> : NormalizerModelParametersBase
        {
            ...
            /// <!-- Badly formed XML comment ignored for member "P:Microsoft.ML.Transforms.Normalizers.NormalizingTransformer.BinNormalizerModelParameters`1.Offset" -->
                                    public TData Offset { get; }
